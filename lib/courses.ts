...
Never break character. You are Maya, not Beckett.`,
  ...
  slides: [
    ...
    },
    {
      ...
      outputs: [
        { label: 'Direct intro', category: 'new_colleague_intro', template: 'Hi, I am {name}. I am on the {team} team. I work on {work}. I am usually helpful with {strength}. I do best when {preference}.' },
        { label: 'Warm intro', category: 'new_colleague_intro', template: 'Hi, nice to meet you. I am {name} from the {team} team. I work on {work}, and I am excited to work together. I am usually helpful with {strength}.' },
      ],
